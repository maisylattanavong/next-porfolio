        ...
        <div className='h-[87vh] flex justify-center flex-col'>
            <div className='w-[80%] mx-auto grid grid-cols-2 lg:grid-cols-5 items-center gap-[5rem]'>
                ...
                <div className='col-span-3'>
                    <h1 data-aos="fade-left" data-aos-delay="400" className='text-[20px] xl:text-[26px] text-orange-500 font-semibold uppercase'>Hello i'm</h1>
                    <h1 data-aos="fade-right" data-aos-delay="600" className='text-[35px] lg:text-[45px] xl:text-[60px] font-bold text-white'>
                        Maisy <span className='text-red-500'>Lattanavong</span>
                    </h1>
                    <h1 data-aos="fade-left" data-aos-delay="800" className='text-[24px] lg:text-[28px] xl:text-[35px] text-white text-opacity-80'>Full Web Developer</h1>
                    <p data-aos="fade-right" data-aos-delay="1200" className='text-[16px] xl:text-[18px] text-white text-opacity-60 mt-[1.5rem]'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Perspiciatis molestiae totam illum et porro quas quasi nobis hic aliquid.
                        Excepturi fugit id distinctio commodi libero saepe dicta natus doloribus dolor!
                    </p>
                    <button data-aos="zoom-in" data-aos-delay="1200"
                     className='group relative mt-[2rem] h-12 w-48 overflow-hidden rounded-full bg-red-500 text-lg shadow'>
