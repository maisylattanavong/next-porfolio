...
const MobileNav = ({showNav,closeNav}:Props) => {
  ...
  return (
    <div>
      ...
      bottom-0 bg-black opacity-70 w-ful h-[100vh]`}>
      ...
      transform transition-all duration-300 delay-300 w-[80%] sm:w-[60%] bg-blue-500 space-y-10 z-[10006]`}>
        ...
        {/**Cross iconf or clos the navbar */}
      <ImCross className='absolute top-[-1.4rem] right-[1.4rem] w-[1.4rem] h-[1.4rem] text-white' 
      onClick={closeNav}/>
      </ul>
